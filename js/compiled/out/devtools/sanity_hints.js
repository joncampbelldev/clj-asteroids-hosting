...
var reader = (function (){var or__20164__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__20164__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__20164__auto__)){
return or__20164__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__34076__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__34076__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__34076__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.sanity_hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e34075){var _e = e34075;
return false;
}});
devtools.sanity_hints.type_error_to_string = (function devtools$sanity_hints$type_error_to_string(self){
var temp__4655__auto___34078 = devtools.sanity_hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___34078)){
var seen_errors_34079 = temp__4655__auto___34078;
if(cljs.core.truth_(seen_errors_34079.has(self))){
} else {
seen_errors_34079.add(self);

var temp__4657__auto___34080 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___34080)){
var sense_34081 = temp__4657__auto___34080;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_34081)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=sanity_hints.js.map?rel=1492251118863