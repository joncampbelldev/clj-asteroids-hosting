...
try{var o__33494__auto__ = f;
return goog.object.get(o__33494__auto__,"toString").call(o__33494__auto__);
}catch (e33574){var _ = e33574;
return "";
}});
...
var char_code = (function (){var o__33494__auto__ = (new String(char$));
return goog.object.get(o__33494__auto__,"charCodeAt").call(o__33494__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__33494__auto__ = String;
return goog.object.get(o__33494__auto__,"fromCharCode").call(o__33494__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__33576 = num_code;
switch (G__33576) {
case (1):
return (185);
...
var o__33494__auto__ = String;
return goog.object.get(o__33494__auto__,"fromCharCode").call(o__33494__auto__,superscript_code);
});
/**
...
}catch (e33582){var e__33519__auto__ = e33582;
return false;
}})())){
...
var vec__33583 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__33583,(0),null);
...
var o__33507__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__33507__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__33506__auto__ = temp__4657__auto____$1;
return goog.object.get(o__33506__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__21239__auto___33592 = arguments.length;
var i__21240__auto___33593 = (0);
while(true){
if((i__21240__auto___33593 < len__21239__auto___33592)){
args__21246__auto__.push((arguments[i__21240__auto___33593]));

var G__33594 = (i__21240__auto___33593 + (1));
i__21240__auto___33593 = G__33594;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21247__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__33588){
var vec__33589 = p__33588;
var ns_detector = cljs.core.nth.call(null,vec__33589,(0),null);
var effective_detector = (function (){var or__20164__auto__ = ns_detector;
...
var G__33595 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__33596 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__33595;
remaining_tokens = G__33596;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq33586){
var G__33587 = cljs.core.first.call(null,seq33586);
var seq33586__$1 = cljs.core.next.call(null,seq33586);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__33587,seq33586__$1);
});
...
break;
default:
var o__33494__auto__ = window;
return goog.object.get(o__33494__auto__,"parseInt").call(o__33494__auto__,arity,(10));
...
var vec__33604 = cljs.core.split_with.call(null,(function (p1__33600_SHARP_){
return cljs.core.not_EQ_.call(null,p1__33600_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__33604,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__33604,(1),null);
...
var vec__33610 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__33610,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__33610,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__33613 = cljs.core.rest.call(null,remaining_tokens);
var G__33614 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__33613;
name_tokens = G__33614;
continue;
} else {
...
var args33615 = [];
var len__21239__auto___33627 = arguments.length;
var i__21240__auto___33628 = (0);
while(true){
if((i__21240__auto___33628 < len__21239__auto___33627)){
args33615.push((arguments[i__21240__auto___33628]));

var G__33629 = (i__21240__auto___33628 + (1));
i__21240__auto___33628 = G__33629;
continue;
} else {
}
break;
...
var vec__33618 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__33618,(0),null);
var arity = cljs.core.nth.call(null,vec__33618,(1),null);
var vec__33621 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__33621,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__33621,(1),null);
var vec__33624 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__33624,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__33624,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__33624,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__33624,(3),null);
...
var args33631 = [];
var len__21239__auto___33637 = arguments.length;
var i__21240__auto___33638 = (0);
while(true){
if((i__21240__auto___33638 < len__21239__auto___33637)){
args33631.push((arguments[i__21240__auto___33638]));

var G__33639 = (i__21240__auto___33638 + (1));
i__21240__auto___33638 = G__33639;
continue;
} else {
}
break;
...
var munged_ns = cljs.core.nth.call(null,vec__33634,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__33634,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__33634,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__33634,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__33634,(4),null);
var arity = cljs.core.nth.call(null,vec__33634,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__33647 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__33647,(0),null);
var args = cljs.core.nth.call(null,vec__33647,(1),null);
var vec__33650 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__33650,(0),null);
var name = cljs.core.nth.call(null,vec__33650,(1),null);
...
var G__33653 = (arity + (1));
var G__33654 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__33655){
var vec__33659 = p__33655;
var arity = cljs.core.nth.call(null,vec__33659,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__33659,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__20164__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__20164__auto__)){
return or__20164__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__33662_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__33663_SHARP_);
...
var args__21246__auto__ = [];
var len__21239__auto___33670 = arguments.length;
var i__21240__auto___33671 = (0);
while(true){
if((i__21240__auto___33671 < len__21239__auto___33670)){
args__21246__auto__.push((arguments[i__21240__auto___33671]));

var G__33672 = (i__21240__auto___33671 + (1));
i__21240__auto___33671 = G__33672;
continue;
} else {
}
break;
...
var argseq__21247__auto__ = ((((1) < args__21246__auto__.length))?(new cljs.core.IndexedSeq(args__21246__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21247__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__33666){
var vec__33667 = p__33666;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__33667,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq33664){
var G__33665 = cljs.core.first.call(null,seq33664);
var seq33664__$1 = cljs.core.next.call(null,seq33664);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__33665,seq33664__$1);
});
...
var G__33674 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__33674) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__20164__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__20164__auto__)){
return or__20164__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__20152__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__20164__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__20164__auto__)){
return or__20164__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__33681__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__33681__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__33681__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__33681__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33682 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__33682,(0),null);
var fn_name = cljs.core.nth.call(null,vec__33682,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__33682,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__33682,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__33682,(4),null);
var arity = cljs.core.nth.call(null,vec__33682,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__20152__auto__ = protocol_ns;
if(cljs.core.truth_(and__20152__auto__)){
return cljs.core.not.call(null,(function (){var and__20152__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__20164__auto__ = protocol_part;
if(cljs.core.truth_(or__20164__auto__)){
return or__20164__auto__;
} else {
return fn_part;
...
//# sourceMappingURL=munging.js.map?rel=1492251118295